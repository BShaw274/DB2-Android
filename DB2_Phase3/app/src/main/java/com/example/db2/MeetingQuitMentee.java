...
public class MeetingQuitMentee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meeting_quit_mentee);
        ...
        QuitSingleButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (MeetingID.matches("")) {
                    Toast.makeText(MeetingQuitMentee.this, "You did not enter a MeetingID", Toast.LENGTH_SHORT).show();
                    return;
                }
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(success){
                                ...
                                Intent intent = new Intent(MeetingQuitMentee.this, PageStudent.class);
                                ...
                                MeetingQuitMentee.this.startActivity(intent);

                            } else{
                                Log.d("Else stmt","In Else stmt !: ");
                                AlertDialog.Builder builder = new AlertDialog.Builder(MeetingQuitMentee.this);
                                builder.setMessage("Meeting ID is Invalid, make sure you entered a valid meeting ID that you can Join as Mentee.").setNegativeButton("Retry", null).create().show();
                            }
                ...
                MeetingRequest MeetingQuitRequest = new MeetingRequest(email, MeetingID, getString(R.string.url) + "RemoveMenteeSingle.php", responseListener2);
                RequestQueue queue = Volley.newRequestQueue(MeetingQuitMentee.this);
        ...
        QuitRecurringButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(success){
                                ...
                                Log.d("Else stmt","In Else stmt !: ");
                                AlertDialog.Builder builder = new AlertDialog.Builder(MeetingQuitMentee.this);
                                builder.setMessage("Meeting ID is Invalid, make sure you entered a valid meeting ID that you can Quit as Mentee.").setNegativeButton("Retry", null).create().show();
                            }
                        } catch (JSONException e) {
                ...
                //Here we use the request format to access the correct php file while passing the correct variables
                MeetingRequest MeetingQuitRequest = new MeetingRequest(email, MeetingID, getString(R.string.url) + "RemoveMenteeRecurring.php", responseListener2);
                RequestQueue queue = Volley.newRequestQueue(MeetingQuitMentee.this);
                queue.add(MeetingQuitRequest);
