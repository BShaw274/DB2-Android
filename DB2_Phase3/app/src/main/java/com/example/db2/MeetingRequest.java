...
public class MeetingRequest extends StringRequest{
    ...
    public MeetingRequest(String email,String MeetID, String url, Response.Listener<String> listener){
        super(Method.POST, url, listener, err);
        args = new HashMap<String, String>();
        args.put("email", email);
        args.put("meet_id", MeetID);
    }
    @Override
