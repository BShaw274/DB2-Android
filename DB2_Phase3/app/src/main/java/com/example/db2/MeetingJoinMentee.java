...
public class MeetingJoinMentee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meeting_join_mentee);
        ...
        JoinSingleButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (MeetingID.matches("")) {
                    Toast.makeText(MeetingJoinMentee.this, "You did not enter a MeetingID", Toast.LENGTH_SHORT).show();
                    return;
                }
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            while(jsonResponse.has(Integer.toString(i) + "cid")){
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(MeetingJoinMentee.this);
                ...
                MeetingRequest MeetingJoinRequest = new MeetingRequest(email, MeetingID, getString(R.string.url) + "signupmenteesingular.php", responseListener2);
                RequestQueue queue = Volley.newRequestQueue(MeetingJoinMentee.this);
        ...
        JoinRecurringButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Here we use the request format to access the correct php file while passing the correct variables
                MeetingRequest MeetingJoinRequest = new MeetingRequest(email, MeetingID, getString(R.string.url) + "signupmenteerecurring.php", responseListener2);
                RequestQueue queue = Volley.newRequestQueue(MeetingJoinMentee.this);
                queue.add(MeetingJoinRequest);
        ...
        ReturnHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MeetingJoinMentee.this, PageStudent.class);
                ...
                MeetingJoinMentee.this.startActivity(intent);
